...
function pt_map(options) 
{
	...
	url = options.root_url + 'json/all_layers.cfm';
...
pt_layer.prototype.render = function (viewport) {
	var layer_url = viewport.ptarmigan_map.root_url + 'json/geojson.cfm?layer_id=' + escape(this.id);
 ...
 */
function pt_status () {
	this.system_message = "Welcome to Geodigraph GIS 2014";
