...
<cfelse>
	...
	<div style="position:relative; height:100%; width:100%; background-color:white;">
		<cfmodule template="#session.root_url#/utilities/dialog_header.cfm" caption="Edit Task" icon="#session.root_url#/images/project_dialog.png">
	
		<cfform name="edit_task" id="edit_task" action="#session.root_url#/project/edit_task.cfm?id=#url.id#&milestone_id=#url.milestone_id#" method="post">
		...
		<div style="position:absolute; bottom:0px; border-top:1px solid #c0c0c0; width:100%; height:45px; background-color:#efefef;">
	    	<div style="padding:8px; float:right;">
				...
				<a class="button" href="##" onclick="form_submit('edit_task');"><span>Apply</span></a>
			</div>
		</div>
	</div>
</cfif>
