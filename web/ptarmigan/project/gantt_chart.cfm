...
<table class="pretty" border="1" cellpadding="5" style="width:100%;margin:0px;">
	...
	<tr>
		<th nowrap><cfoutput><strong style="font-weight:bolder;">#project.project_name# <cfmodule template="/ptarmigan/link_box.cfm" text="Milestone" symbol="+" href="##"></cfoutput></th>
		<th>START</th>
		<th>END</th>
		<th>DAYS</th>
		<cfset current_date = project.start_date>
