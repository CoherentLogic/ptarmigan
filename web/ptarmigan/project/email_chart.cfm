...
<cfif IsDefined("form.self_post")>
	...
	<cfset output_file = "#p.id#_gantt.pdf">
	...
	<cfmail from="#session.user.email#" to="#form.recipient#" subject="#form.subject#" type="text/html" mimeattach="#output_file_path#">
		...
		Attached: Gantt chart for #p.project_name#<br>
		<hr>
		<center>
...
<cfelse>
	<div style="position:relative; height:100%; width:100%; background-color:white;">
		...
		<cfform name="email_chart" id="email_chart" action="#session.root_url#/project/email_chart.cfm?project_id=#url.project_id#" method="post">
			<div style="padding:20px;">
				<table>
					...
					<tr>
						<td>Subject:</td>
						<td><cfinput type="text" size="40" name="subject" value="#p.project_name# GANTT CHART"></td>
					</tr>
				</table>
			</div>
